  ...
  return (
    ...
    <div className="flex flex-col h-screen bg-base text-text-hi overflow-hidden">
      ...
      <div className="flex-shrink-0 border-t border-border bg-surface px-3 py-2">
        <ControlBar onAction={runAction} loading={actionLoading} scenarios={[demoScenarios[0], demoScenarios[2], demoScenarios[3]].filter(Boolean)} onRunScenario={runDemoStep} />
      </div>
